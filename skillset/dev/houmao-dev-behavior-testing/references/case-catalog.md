...
Catalog version: `houmao-dev-behavior-cases.v6`
...
`complete` means complete for `houmao-dev-behavior-cases.v6`; it does not claim coverage of uncommitted product behavior.
...
| `native-prompt` | 1 | 2 | 3 | 4 | [cases/native-prompt.md](cases/native-prompt.md) |
...
| `all` | 15 | 31 | 53 | 56 | Union of all functional areas |

## Cross-Cutting Tags

Tags retain their membership through version 6. They are overlapping views and do not change functional ownership or cumulative profile membership.

- `critical`: `ACT-001`, `ACT-002`, `ACT-003`, `ACT-004`, `ACT-005`, `NSP-001`, `NSP-002`, `ADM-003`, `ADM-004`, `ADM-006`, `AGT-002`, `AGT-004`, `AGT-005`, `SHR-001`, `SHR-002`, `SHR-004`, `SHR-009`, `LOOP-001`, `LOOP-002`, `LOOP-003`, `LOOP-008`, `PRM-001`, `PRM-002`, `ADF-001`, `ADF-002`, `ADF-003`, `ADF-004`, and `ADF-006`.
